...
public class Screen3 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<ReturnInfo> info = new ArrayList<ReturnInfo>();
        ReturnInfoAdapter infoAdapter = new ReturnInfoAdapter(this, info);
        ListView listView = (ListView) findViewById(R.id.all_return);
